...
def training_loop(train_dataloader, opts):
    ...
    for _ in range(opts.num_epochs):
        ...
        for batch in train_dataloader:
            ...
            D_real_loss = bce_loss(D(real_images), torch.ones_like(D(real_images)))
            ...
            D_fake_loss = bce_loss(D(fake_images.detach()), torch.zeros_like(D(fake_images.detach())))
            ...
            G_loss = bce_loss(D(fake_images), torch.ones_like(D(fake_images)))
