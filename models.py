...
class DCDiscriminator(nn.Module):
    ...
    def __init__(self, conv_dim=64, norm='instance'):
        ...
        self.conv2 = conv(in_channels=32, out_channels=conv_dim, kernel_size=4, stride=2, padding=1, norm=norm, init_zero_weights=False, activ='relu')
        self.conv3 = conv(in_channels=conv_dim, out_channels=conv_dim*2, kernel_size=4, stride=2, padding=1, norm=norm, init_zero_weights=False, activ='relu')
        self.conv4 = conv(in_channels=conv_dim*2, out_channels=conv_dim*4, kernel_size=4, stride=2, padding=1, norm=norm, init_zero_weights=False, activ='relu')
        self.conv5 = conv(in_channels=conv_dim*4, out_channels=1, kernel_size=4, stride=1, padding=0, norm=None, init_zero_weights=False, activ=None)
